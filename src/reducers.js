...
import { FETCH_PAINTINGS, SELECT_ACTIVE_PAINTING, DELETE_PAINTING, FILTER_MUSEUMS } from './actions/types';
...
const paintingsReducer = (state = [], action) => {
  switch (action.type) {
    ...
    case FILTER_MUSEUMS:
      return state.filter(painting => painting.museum.id === action.id)
    default:
      return state;
  }
};
